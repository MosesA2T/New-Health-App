...
public final class ActivitySplashscreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView mIvSplashScreen;

  private ActivitySplashscreenBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView mIvSplashScreen) {
    this.rootView = rootView;
    this.mIvSplashScreen = mIvSplashScreen;
  }
  ...
  public static ActivitySplashscreenBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.mIvSplashScreen;
      ImageView mIvSplashScreen = ViewBindings.findChildViewById(rootView, id);
      if (mIvSplashScreen == null) {
        break missingId;
      }

      return new ActivitySplashscreenBinding((RelativeLayout) rootView, mIvSplashScreen);
    }
